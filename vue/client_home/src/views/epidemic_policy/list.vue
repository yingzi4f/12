<template>
	<div class="diy_list page_epidemic_policy" id="epidemic_policy_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">疫情政策列表</span>
					</div>
				</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_epidemic_policy :list="list" />
						<!-- /列表 -->
					</div>
				</div>
		...
		data() {
			return {
				...
				list_sort: [{
					...
					{
						name: "地区名称正序",
						value: "region_name asc",
					},
					{
						name: "地区名称倒序",
						value: "region_name desc",
					},
				],
			}
		},
