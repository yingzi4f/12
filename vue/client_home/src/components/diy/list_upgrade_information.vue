<template>
	<div class="diy_home diy_list diy_upgrade_information" id="diy_upgrade_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/upgrade_information/details?upgrade_information_id=' + o['upgrade_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/upgrade_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/upgrade_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','ticket_replacement_amount')">补票金额
					</th>
					<th class="diy_title" v-if="$check_field('get','reason_for_application')">申请原因
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_number" v-if="$check_field('get','ticket_replacement_amount')">
						<span>
							{{ o["ticket_replacement_amount"] }}
						</span>
					</td>
		...
		data() {
			return {
						...
						itemList: [
								...
								{
									title: "补票金额",
									name: "ticket_replacement_amount",
									type: "数字",
									is_img_list: "0"
								},
						],
