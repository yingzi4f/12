<template>
	<div class="diy_details_box diy_div_passenger_plane_management">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "passenger_plane_management",
					source_field: "passenger_plane_management_id",
					source_id: this.obj["passenger_plane_management_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/passenger_plane_management/set?passenger_plane_management_id=' + _this.obj["passenger_plane_management_id"], {
								praise_len
							}, (res) => {
								if(res.result){
