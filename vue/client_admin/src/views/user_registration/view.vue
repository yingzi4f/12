		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','account_number') || $check_field('add','account_number') || $check_field('set','account_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="账号编号" prop="account_number">
					<el-input id="account_number" v-model="form_sub['account_number']" placeholder="请输入账号编号"
							  v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','account_number')) || (!form_sub['user_registration_id'] && $check_field('add','account_number'))"></el-input>
					<div v-else-if="$check_field('get','account_number')">{{form_sub['account_number']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','account_balance') || $check_field('add','account_balance') || $check_field('set','account_balance')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="账户余额" prop="account_balance">
					<el-input-number id="account_balance" v-model.number="form_sub['account_balance']"
						v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','account_balance')) || (!form_sub['user_registration_id'] && $check_field('add','account_balance'))"></el-input-number>
					<div v-else-if="$check_field('get','account_balance')">{{form_sub['account_balance']}}</div>
				</el-form-item>
			</el-col>
